...
<body id="page-top">
  ...
  <!-- Page Wrapper -->
    <div id="wrapper">
        ...
        <!-- Nav Item - Dashboard -->
        <li class="{{ Request::segment(1) === '/home'  ? 'nav-item active' : 'nav-item active' }}">
        ...
        <!-- Nav Item - Pages Collapse Menu -->
        <li  class="{{ Request::segment(1) === 'orders' || Request::segment(1) === 'order_invoice' ? 'nav-item active' : 'nav-item' }}">
        ...
        <!-- Nav Item - Charts -->
        <li class="{{ Request::segment(1) === 'transaction' || Request::segment(1) === 'sales_invoice'  ? 'nav-item active' : 'nav-item' }}">
        ...
        <!-- Nav Item - Tables -->
        <li class="{{ Request::segment(1) === 'products' ? 'nav-item active' : 'nav-item' }}">
